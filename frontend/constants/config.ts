export const CONFIG = {
API_BASE_URL: process.env.EXPO_PUBLIC_API_URL || 'https://abualzahracom.online/api/v1',  
  API_TIMEOUT: 10000,

  WEBSOCKET_URL: process.env.EXPO_PUBLIC_WEBSOCKET_URL || 'wss://abualzahracom.online/ws',
